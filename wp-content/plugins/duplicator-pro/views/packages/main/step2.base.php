...
else if($global->archive_build_mode == DUP_PRO_Archive_Build_Mode::DupArchive)
{
    $archive_build_mode = DUP_PRO_U::__('DupArchive');
}
else
{
		...
		<div class="dup-panel">
			...
			<div class="dup-panel-panel">
				<table class="dup-scan-db-details">
					<tr><td><b><?php DUP_PRO_U::_e('Archive'); ?></b></td><td><a href="?page=duplicator-pro-settings&tab=package" target="_blank"><?php echo $archive_build_mode; ?></a> </td></tr>
					<tr>
