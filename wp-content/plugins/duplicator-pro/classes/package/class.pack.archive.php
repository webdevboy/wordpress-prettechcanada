...
require_once ('duparchive/class.pack.archive.duparchive.php');
        ...
        try {
            ...
            switch ($this->Format) {
                ...
                default:
                    ...
                    if ($build_progress->current_build_mode == DUP_PRO_Archive_Build_Mode::Shell_Exec) {
                    ...
                    } else if($build_progress->current_build_mode == DUP_PRO_Archive_Build_Mode::ZipArchive) {
                        ...
                        $completed = DupProDupArchive::create($this, $build_progress);
                    }
