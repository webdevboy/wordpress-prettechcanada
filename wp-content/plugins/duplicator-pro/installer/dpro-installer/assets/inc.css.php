<style>
	...
	/*DATABASE CHECKS */
	div.s2-dbtest-area {margin:auto; margin:10px 0 15px 0;}
	...
	div.s2-dbtest-area div.message {padding:10px; margin:15px auto 5px auto; text-align:center; font-style:italic; font-size:15px; line-height:20px}
