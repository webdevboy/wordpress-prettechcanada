...
class DUPX_DB
{
	 ...
	 *
	 * @return array	Returns the orginal $collations array with the original names and a found status
     ...
     */
    public static function getDatabases($dbh)
    {
        $query = @mysqli_query($dbh, 'SHOW DATABASES');
        if ($query) {
     ...
     * @return null
     */
    public static function renameTable($dbh, $existing_name, $new_name, $delete_if_conflict)
    {
