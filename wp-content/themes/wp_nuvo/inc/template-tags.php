...
function cshero_post_nav() {
	...
	<nav class="navigation post-navigation clearfix" role="navigation">
		<div class="nav-links">
			<?php
				previous_post_link('<div class="nav-previous">%link</div>', '<span class="btn btn-default"><i class="fa fa-chevron-circle-left"></i>'.__('PREVIOUS POST', THEMENAME).'</span>');
				next_post_link('<div class="nav-next">%link</div>', '<span class="btn btn-default">'.__('NEXT POST', THEMENAME).'<i class="fa fa-chevron-circle-right"></i></span>');
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
