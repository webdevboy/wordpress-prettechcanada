...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="cs_add_to_cart_button single_add_to_cart_button btn-primary-alt border-radius-10"><?php echo $product->single_add_to_cart_text(); ?></button>
