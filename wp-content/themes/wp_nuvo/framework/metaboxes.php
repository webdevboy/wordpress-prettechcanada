...
class CsheroFrameworkMetaboxes {
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('page_options', __('Page Options',THEMENAME), 'page');
		$this->add_meta_box('post_options', __('Post Options',THEMENAME), 'post');
		...
		$this->add_meta_box('restaurantmenu', __('Menu Setting',THEMENAME), 'restaurantmenu');
		$this->add_meta_box('pointofsale', __('Point of Sale',THEMENAME), 'pointofsale');
	}
