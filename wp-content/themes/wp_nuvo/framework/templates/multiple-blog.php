		...
		<div class="cs-blog-info">
            <ul class="unliststyle">
            	...
            	<?php if($smof_data['detail_author'] == '1'): ?>
                    <li><?php _e('Posted by ',THEMENAME); the_author_posts_link(); ?></li>
                <?php endif; ?>
            	<?php
            	...
            	<li><a href="<?php echo get_the_permalink(); ?>" title="<?php _e('View all Comments', THEMENAME); ?>"><?php comments_number(__('0 Comments',THEMENAME),__('1 Comments',THEMENAME),__('% Comments',THEMENAME)); ?></a></li>
            	<?php endif; ?>
 ...
 */
 function cshero_read_more_render(){
	...
	ob_start();
	?>
	<div class="readmore text-right"><a href="<?php echo esc_url( get_permalink()); ?>" class="btn btn-default"><?php echo __('READ MORE',THEMENAME); ?><i class="fa fa-chevron-circle-right"></i></a></div>
	<?php
	return  ob_get_clean();
}