			...
			<div class="cs-blog-meta cs-itemBlog-meta">
			    <div class="cs-blog-info clearfix">
    			    <div class="cs-blog-eventsDate col-xs-12 col-sm-3 col-md-3 col-lg-3">
    			        <span><?php _e('DATE / TIME', THEMENAME); ?></span>
        				<!-- .info-bar -->
                        <?php
                        $querystr = "
                    ...
                    <div class="cs-blog-eventsBooking col-xs-12 col-sm-9 col-md-9 col-lg-9">
                        <a href="#" class="btn btn-primary-alt btn-white" data-toggle="modal" data-target="#modal-booking" title="<?php _e('BOOK THIS AMAZING EVENT NOW', THEMENAME); ?>"><?php _e('BOOK THIS AMAZING EVENT NOW', THEMENAME); ?></a>
                    </div>
                </div>
                <!-- Modal -->
                <div class="modal fade" id="modal-booking" tabindex="-1" role="dialog" aria-labelledby="<?php _e('BOOK THIS AMAZING EVENT NOW', THEMENAME); ?>" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <h4 class="modal-title"><?php _e('BOOK THIS AMAZING EVENT NOW', THEMENAME); ?></h4>
                            </div>
