	...
	<form id="cs-booking-form" method="POST" action="<?php echo esc_attr( $booking_page ); ?>">
		...
		<div class="row">
		    <div class="cs-bookTable-date col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<label for="rtb-date"><?php _e( 'When would you like to book?', THEMENAME ); ?></label>
				<span class="Selectoptions"><input type="text" name="rtb-date" id="rtb-date" value="<?php echo cs_booking_request_input('request_date'); ?>" placeholder="<?php _e('Select Date', THEMENAME); ?>"></span>
			...
			<div class="cs-bookTable-party col-xs-12 col-sm-2 col-md-2 col-lg-2">
				<label for="rtb-party"><?php _e( 'Party Size :', THEMENAME ); ?></label>
			...
			<div class="cs-bookTable-time col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<label for="rtb-time"><?php _e( 'Preferred dining time:', THEMENAME ); ?></label>
				<span class="Selectoptions"><input type="text" name="rtb-time" id="rtb-time" value="<?php echo cs_booking_request_input('request_time'); ?>" placeholder="<?php _e('Select Time', THEMENAME); ?>"></span>
		...
		<div class="row">
		    <div class="name col-xs-12 col-sm-6 col-md-6 col-lg-6">
			     <input type="text" name="rtb-name" id="rtb-name" placeholder="<?php _e('Name', THEMENAME); ?>" value="<?php echo cs_booking_request_input('name'); ?>">
			     <?php echo rtb_print_form_error( 'name' ); ?>
			</div>
			<div class="email col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<input type="text" name="rtb-email" id="rtb-email" placeholder="<?php _e('Email', THEMENAME); ?>" value="<?php echo cs_booking_request_input('email'); ?>">
				<?php echo rtb_print_form_error( 'email' ); ?>
			</div>
		</div>
		<div class="row">
		    <div class="phone col-xs-12 col-sm-6 col-md-6 col-lg-6">
    		    <input type="text" name="rtb-phone" id="rtb-phone" placeholder="<?php _e('Phone', THEMENAME); ?>" value="<?php echo cs_booking_request_input('phone'); ?>">
			...
			<div class="message col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<input type="text" name="rtb-message" id="rtb-message" placeholder="<?php _e('Message', THEMENAME); ?>" value="<?php echo cs_booking_request_input('message'); ?>">
			</div>
		</div>
		...
		<div class="cs-bookTable-submit">
			<button class="btn btn-default" type="submit"><?php _e( 'BOOK MY TABLE', THEMENAME ); ?></button>
			<span class="des-text"><?php echo _e('Please submit your reservation details and we will contact you to confirm your booking ',THEMENAME);?></span>
		</div>
