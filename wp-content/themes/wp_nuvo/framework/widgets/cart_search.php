...
class WC_Widget_Cart_Search extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="widget_cart_search_wrap">
            ...
            <a href="javascript:void(0)" class="icon_cart_wrap" data-display=".shopping_cart_dropdown" data-no_display=".widget_searchform_content"><span class="cart_total"><?php
                echo $woocommerce?' '.$woocommerce->cart->get_cart_contents_count():'';?></span><?php echo _e( " Item in cart ", THEMENAME );?><i class="fa fa-shopping-cart cart-icon"></i></a>
            <?php endif; ?>
    ...
    function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_url($this->get_field_id('title')); ?>"><?php _e( 'Title:', THEMENAME ); ?></label>
