    ...
    function form($instance) {
        ...
        <p>
            ...
            <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('show_date') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_date') ); ?>">
                <option value="1"<?php if(isset($instance['show_date']) && $instance['show_date'] == '1'){ echo ' selected="selected"'; } ?>><?php _e('Yes', THEMENAME); ?></option>
                <option value="0"<?php if(isset($instance['show_date']) && $instance['show_date'] == '0'){ echo ' selected="selected"'; } ?>><?php _e('No', THEMENAME); ?></option>
            </select>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e( 'Number of products to show:', THEMENAME ); ?></label>
