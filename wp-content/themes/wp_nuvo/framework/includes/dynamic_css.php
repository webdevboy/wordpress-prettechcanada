...
<style type="text/css">
    ...
    .cs_mega_menu #sticky-nav-wrap ul {
        width: <?php echo esc_attr($smof_data['dropdown_menu_width']); ?>;
    }
    ...
    <?php if(is_rtl()){ ?>
        ...
        .cshero-menu-dropdown li.nomega-menu-item ul ul ul {
            right: <?php echo esc_attr($smof_data['dropdown_menu_width']); ?> !important;
        }
    ...
    <?php } else {?>
        .cshero-menu-dropdown li.nomega-menu-item ul ul ul {
            left: <?php echo esc_attr($smof_data['dropdown_menu_width']); ?> !important;
        }
        .cshero-menu-dropdown li.nomega-menu-item ul ul ul.back {
            left: -<?php echo esc_attr($smof_data['dropdown_menu_width']); ?> !important;
        }
